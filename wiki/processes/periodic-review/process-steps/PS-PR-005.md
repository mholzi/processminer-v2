...
provenance: {"Inputs":{"source":"document","evidence":"Owner. Financial Crime Operations Analyst (FCO Analyst). SLA. 5 working days from case ready-for-review. The analyst sees a single screen with: The completeness score and the explicit reason for non-STP. The full evidence pack, with provenance — every fact links to its source record. The risk model's rating with feature contributions. Open screening hits with the analyst's tooling to clear or escalate."},"Outputs":{"source":"document","evidence":"Decision options: Approve. Recorded with rationale. Approve with conditions. E.g. monitoring tier raised, debit cap applied, product restriction. Refer to EDD. Triggers the Enhanced Due Diligence subprocess. Recommend exit. Sent to FCO sign-off (Step 6)."},"What happens":{"source":"document","evidence":"The analyst sees a single screen with: The completeness score and the explicit reason for non-STP. The full evidence pack, with provenance — every fact links to its source record. The risk model's rating with feature contributions. Open screening hits with the analyst's tooling to clear or escalate."},"Why it matters":{"source":"proposed","evidence":""}}
---
## What happens
