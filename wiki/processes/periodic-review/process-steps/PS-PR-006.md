...
provenance: {"Inputs":{"source":"document","evidence":"Mandatory for: High-risk clients, PEPs, recommend-exit decisions, approve-with-conditions where the condition restricts a regulated product, and a random 5 % QA sample of STP and analyst approvals."},"Outputs":{"source":"proposed","evidence":""},"What happens":{"source":"document","evidence":"Owner. Financial Crime Officer (FCO) — 4-eyes principle. Mandatory for: High-risk clients, PEPs, recommend-exit decisions, approve-with-conditions where the condition restricts a regulated product, and a random 5 % QA sample of STP and analyst approvals. Sign-off is recorded against the FCO's identity (SSO) and is immutable."},"Why it matters":{"source":"document","evidence":"Opaque escalation. Whether a case escalates to FCO depends on the analyst on duty, not a written rule."}}
---
## What happens
