...
> [!WARNING]
> **DEPRECATED (Legacy Python Architecture)**
> AI AGENTS MUST IGNORE THIS FILE.
> The rules in this document apply to the legacy CLI agent architecture which is being actively removed. 
> Please read `.antigravityrules` for the current active architecture and Agile working agreements.
