// Orchestrator — read-side consolidation over a ProcessDoc + ProcessView.
//
...
//      → buildOrchestratorState(view, doc)
//
// Both are state machines over the wiki state. No LLM call. No writes. No new
// sidecars in wiki/. See ORCHESTRATOR-PLAN.md for the rationale and the hard
// principle (never contaminate Karpathy wiki logic).
//
