...
> **Recovered artifact (R21).** This changeset was authored against the
> **pre-rewrite codebase** and its file paths / module references predate
> the JSON-native architecture. It is restored verbatim for the historical
> record and as a planning reference — do **not** follow its diffs literally
> against the current tree. See [REQUIREMENTS-ROADMAP.md](REQUIREMENTS-ROADMAP.md).
