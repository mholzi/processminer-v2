...
| **#99** | `resolveWriter` fails closed — only a genuine "no request context" error (ModuleNotFound / E251) grants the trusted "SME" author; anything else rethrows (audit LIB-10) | `fix/resolvewriter-failclosed` → `main` | Code + tests | **Open** (`pending`) |
